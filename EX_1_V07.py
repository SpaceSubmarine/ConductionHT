...
print('Enter temperature of the first fluid T_a in Celsius:')
T_a = int(input())
#T_a = 25
print('Enter temperature of the second fluid T_b in Celsius:')
T_b = int(input())
#T_b = 25
print('Enter the convection heat transfer coefficient of the first fluid "alpha_a":')
alpha_a = int(input())
#alpha_a = 2000 #W/(m^2 k)
print('Enter convection heat transfer coefficient of the second fluid "alpha_b":')
alpha_b = int(input())
#alpha_b = 2000 # random number  W/(m^2 k)
print("Enter the internal heat energy 'q_dot_u' (constant) of the solid material:")
alpha_b = float(input())
...
print('Introduce the conduction heat transfer value (constant), of the chosen material in W/mK :')
lambda_1 = int(input())
...
# N = 10
Max_error = (10**(-18))
print('Enter the temperature of the solid material in Celsius:')
#T_b = int(input())
T_input = int(input())
T_input = 250
T_input = T_input+273
...
if iteration < 50:
    print("\nThe number of iterations seems to be very lower", 
    "\n it seems that the code has something wrong with the coefficients \n or with the Gauss-Seidel method")
